...
#define OLED_D(format, ...) ESP_LOG_LEVEL_LOCAL(ESP_LOG_DEBUG, this->getObjectNameCStyle(), format, ##__VA_ARGS__);
#define OLED_I(format, ...) ESP_LOG_LEVEL_LOCAL(ESP_LOG_INFO, this->getObjectNameCStyle(), format, ##__VA_ARGS__)
